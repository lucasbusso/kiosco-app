  ...
  return (
    <div className="shadow p-5 mb-3 flex gap-10 bg-gray-50">
        ...
        <div className="my-auto mr-5">
          ...
          <button
            type="button"
            className="bg-sky-700 flex gap-3 px-5 py-2  text-white rounded-md font-bold uppercase shadow-md w-full"
          ...
          <button
            type="button"
            className="bg-red-700 flex gap-3 px-5 py-2 text-white rounded-md font-bold uppercase shadow-md w-full mt-5"
